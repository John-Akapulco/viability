...
merged against connectivity_vs_formation_energy.csv, 349-compound cap;
...
compute_icobi_antibonding_all.py: analysis/connectivity_vs_antibonding.csv
...
CONNECTIVITY_CSV = Path(__file__).parent / "connectivity_vs_antibonding.csv"
