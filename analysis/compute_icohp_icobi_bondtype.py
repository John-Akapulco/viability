...
was reused from analysis/connectivity_vs_antibonding.csv, which averages
...
correct for connectivity-graph connectivity (connectivity_path.py's actual
...
depending on analysis/connectivity_vs_antibonding.csv's batch coverage --
        ...
        for compound_dir in sorted(STRUCTURES_ROOT.iterdir()):
            ...
            rows.append({
                ...
                **classified,
                ...
                # not the old diluted connectivity-graph mean.
