...
(analysis/connectivity_vs_antibonding.csv) against formation_energy_per_atom.
...
CSV_PATH = HERE / "connectivity_vs_antibonding.csv"
...
COMPARISON_METRICS = {
    ...
    "icohp_connectivity_weight_min_normalized": "connectivity weight (normalized)",
    "icohp_sum": "ICOHP sum",
