...
analysis/connectivity_vs_formation_energy.csv -> analysis/connectivity_vs_antibonding.csv.
"""
...
CONNECTIVITY_CSV = Path(__file__).parent / "connectivity_vs_formation_energy.csv"
OUT_JSON = Path(__file__).parent / "antibonding_all.json"
OUT_CSV = Path(__file__).parent / "connectivity_vs_antibonding.csv"
