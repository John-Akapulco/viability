...
and isn't in analysis/connectivity_vs_antibonding.csv (that CSV's own base,
connectivity_vs_formation_energy.csv, only covers the pre-maxhull 349 --
this batch was never run through connectivity_path.py). Needed to compare
