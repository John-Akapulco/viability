...
| connectivity weight (raw) | 186 | 0.111 | 0.132 |
| connectivity weight (normalized) | 186 | 0.090 | 0.223 |
...
*Code*: `analysis/compute_antibonding_all.py` (extraction, all 186 compounds), `analysis/stats_analysis_antibonding.py` (statistics + figures). `cohp_extraction.py` untouched from the pilot-validated version. *Data*: `analysis/antibonding_all.json`, `analysis/connectivity_vs_antibonding.csv`, `analysis/stats_summary_antibonding.json`. *Figures*: `analysis/figures_antibonding/`.
