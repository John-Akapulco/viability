...
- **`analysis/stats_analysis_antibonding.py`**: same statistical convention as before, rerun unmodified against the new `analysis/connectivity_vs_antibonding.csv` (349 rows).
...
| icohp_connectivity_weight_min (raw) | 346 | 0.229 | ~0 |
| icohp_connectivity_weight_min (normalized) | 345 | 0.172 | 0.0014 |
...
*Code*: `analysis/compute_antibonding_all.py` (extraction, all 349 compounds), `analysis/stats_analysis_antibonding.py` (statistics + figures). `cohp_extraction.py` untouched since the pilot-validated version. *Data*: `analysis/antibonding_all.json`, `analysis/connectivity_vs_antibonding.csv`, `analysis/stats_summary_antibonding.json`. *Figures*: `analysis/figures_antibonding/`.
