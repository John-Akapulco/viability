...
- formation_energy_per_atom: primarily from connectivity_vs_formation_energy.csv
...
connectivity_vs_formation_energy.csv is used instead of the sparse one
already in reaction_icohp_case1.csv.

Comparison against prior descriptors (connectivity weight, min-cut,
...
MAIN_CSV = HERE / "connectivity_vs_formation_energy.csv"
ANTIBOND_CSV = HERE / "connectivity_vs_antibonding.csv"
...
COMPARISON_METRICS = {
    ...
    "icohp_connectivity_weight_min_normalized": "connectivity weight (normalized, mission #1)",
...
def load_merged() -> pd.DataFrame:
    ...
    main = pd.read_csv(MAIN_CSV)[[
        ...
        "icohp_connectivity_weight_min_normalized", "mincut_icohp_min_normalized",
    ]]
