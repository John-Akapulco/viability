# connectivity_path.py

Descripteur de « chemin de connectivity de moindre résistance » calculé par
...
does change the connectivity weight substantially for compounds whose cell
...
Two new descriptors, `connectivity_path.py` untouched:
...
instabilities. New module `cohp_extraction.py` (`connectivity_path.py`
