\begin{longtable}{@{}l l@{}}
\caption{PAW-PBE potentials used, one per element present in the dataset (pymatgen's MPRelaxSet library, with one documented exception: W substituted for W\_pv/W\_sv (\S\ref{sec:si-qc})).}\label{tab:si-potcar}\\
\toprule
