...
\caption{Réactions de décomposition en éléments (cas 1) classées \textbf{exobondic} ($\Delta$ICOHP $< 0$, produits $-$ réactifs) parmi les 163 composés de la campagne \texttt{extension}. $^*$ = composé de départ expérimental.}\\
\toprule
