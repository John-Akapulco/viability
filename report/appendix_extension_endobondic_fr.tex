...
\caption{Réactions de décomposition en éléments (cas 1) classées \textbf{endobondic} ($\Delta$ICOHP $\geq 0$, produits $-$ réactifs) parmi les 163 composés de la campagne \texttt{extension}. $^*$ = composé de départ expérimental.}\\
\toprule
