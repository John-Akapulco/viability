...
campaigns --- see \S\ref{sec:reframing}. \texttt{percolation\_path.py}
...
and unstable compounds?} This supersedes the percolation-weight-centric
framing that the body of this report (\S\ref{sec:reframing} and earlier)
documents --- \texttt{percolation\_path.py} (mission \#1) and
