...
the connectivity-weight metric. Writes appendix_compounds_fr.tex and
...
CSV_PATH = HERE.parent / "analysis" / "connectivity_vs_hull.csv"
...
def build(lang: str) -> str:
    ...
    header = {
        "fr": ("Formule", "mp-id", "Liaison", r"$E_\text{hull}$ (eV/at)", "Poids connectivity (eV)"),
        "en": ("Formula", "mp-id", "Bonding", r"$E_\text{hull}$ (eV/at)", "Connectivity weight (eV)"),
    }[lang]
    caption = {
        "fr": "Liste compl\\`ete des 186 compos\\'es, class\\'es par cat\\'egorie, avec identifiant Materials Project, distance au hull (PBE), et poids de connectivity ICOHP minimal.",
        "en": "Complete list of the 186 compounds, grouped by category, with their Materials Project identifier, PBE hull distance, and minimum ICOHP connectivity weight.",
    }[lang]
    ...
    for family in FAMILY_ORDER:
        ...
        for _, row in sub.iterrows():
            ...
            w = fmt_w(row["icohp_connectivity_weight_min"])
